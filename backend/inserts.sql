...
FROM
	PETS
	INNER JOIN OWNERS_PETS ON PETS.ID = OWNERS_PETS.PET_ID;
---
...
FROM
	OWNERS
	INNER JOIN OWNERS_PETS ON OWNERS.ID = OWNERS_PETS.OWNER_ID;
...
FROM
	OWNERS
	INNER JOIN PERSONAL_DATA ON OWNERS.PERSONAL_DATA_ID = PERSONAL_DATA.ID;

--
INSERT INTO
	OWNERS (PERSONAL_DATA, PROFILE_IMAGE_ID),
VALUES
	();

INSERT INTO
	OWNERS_PETS (OWNER_ID, PET_ID, START_DATE),
VALUES
	();
